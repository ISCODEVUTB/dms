...
class TestAddress(unittest.TestCase):
    ...
    myaddress = Address("colombia","bolivar","cartagena","1101","Horizonte","mzn3","house")
        
    def test_instance(self):
        self.assertIsInstance(self.myaddress, Address, "It's an instance of Address!")
    ...
    def test__str__(self):
        self.assertEqual(self.myaddress.__str__(),{'country': "colombia", 'department': "bolivar", 'city': "cartagena",  'post_code': "1101",'neighborhood': "Horizonte",'street': "mzn3",'complement': "house"})
