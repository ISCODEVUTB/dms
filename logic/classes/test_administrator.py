...
class TestAdministrator(unittest.TestCase):
    admin = Administrator(10, 'ian', 'montoya', '3032846010', 'montoya@mail.com')
    ...
    def test__str__(self):
        self.assertEqual(self.admin.__str__(), {'id': 10, 'name': "ian", 'last_name': "montoya",  'phone': "3032846010",'mail': "montoya@mail.com"})
