import unittest
from invbook import InvBook
from datetime import date

class TestInvBook(unittest.TestCase):
    inv_book = InvBook(123, "ian", "The Science of Cooking", 29.99, "Food Science", "English", date(2020, 1, 1), 10.5, "10.1000/182", 350, "An exploration of the chemistry and physics behind cooking techniques")
    print(inv_book.__str__())
    def test_instance(self):
        self.assertIsInstance(self.inv_book, InvBook, "It's an instance of InvBook")
    ...
    def test_abstract(self):
        self.assertEqual(self.inv_book.abstract, "An exploration of the chemistry and physics behind cooking techniques")
